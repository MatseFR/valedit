...
class LayerEvent extends Event 
{
	...
	static private function fromPool(type:String, layer:ITimeLineLayer, object:ValEditObject, bubbles:Bool, cancelable:Bool):LayerEvent
	{
	...
	static public function dispatch(dispatcher:IEventDispatcher, type:String, layer:ITimeLineLayer, object:ValEditObject = null,
	...
	public var layer(default, null):ITimeLineLayer;
	public var object(default, null):ValEditObject;
	
	public function new(type:String, layer:ITimeLineLayer, object:ValEditObject, bubbles:Bool=false, cancelable:Bool=false) 
	{
	...
	private function setTo(type:String, layer:ITimeLineLayer, object:ValEditObject, bubbles:Bool, cancelable:Bool):LayerEvent
	{
		this.type = type;
		this.layer = layer;
		this.object = object;
