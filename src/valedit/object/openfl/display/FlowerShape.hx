 ...
 * @author Matse
 */
class FlowerShape extends BaseShape 
{
	...
	private function get_innerRadius():Float { return this._outerRadius; }
	...
	private function get_outerRadius():Float { return this._innerRadius; }
