...
class ExposedSelect extends ExposedValue 
{
	...
	**/
	...
	{
		var select:ExposedSelect = fromPool(this.propertyName, this.name, choiceList != null ? choiceList.copy():null, valueList != null ? valueList.copy():null, listPercentWidth);
